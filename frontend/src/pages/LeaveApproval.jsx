...
import { decideLeave, getTeamLeaves } from "../api/leaves.js";
...
export default function LeaveApproval() {
  ...
  const handleDecision = async (id, approved) => {
    ...
    await decideLeave(id, approved, approved ? "Approved" : "Rejected");
    await loadLeaves();
    setActionState("");
  };
    ...
    <div className="card p-6">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm text-slate-500">{actionState}</span>
        </div>
      </div>
